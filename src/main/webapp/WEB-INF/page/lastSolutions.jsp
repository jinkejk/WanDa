						...
						<c:if test="${solutions.size() > 0}">
			                <c:forEach var="solution" items="${solutions}" varStatus="status">
				                <li><div class="rp_title2">
				                        <a href="searchSolution_searchSolutionById?solutionId=${solution.solutionId}" target="_blank">${solution.title}</a>
				                    </div>
					                <div class="rp_item2">
						...
						<div class="hot_panel" id="hot_Panel">
			                ...
			                <c:forEach var="solution" items="${hotVisitSolution}" varStatus="status">
				                <li><span class="hot_item" id="hot_Item">
					                ...
					                <span class="hot_push" id="hot_Push">点击率：<span class="count" id="Count">${solution.clickNum}</span></span>
			                    </li>							
			                </c:forEach>
		                 </c:if>
