...
<head>
    ...
    <script type="text/javascript">
        ...
        function menuClick(TMCId) {
            //alert(TMCId);
            window.location.href = "searchSolution_searchSolutionByCategory?flag=1&pageSize=15&TMCId=" + TMCId + "&currentPage=1";
        }
    </script>
...
<div id="bg">
    ...
    <div class="head">
        ...
        <span class="login_message">
			<span class="welcome"><img id="userimg" src="image/problem/user.png"/>欢迎：<span class="username"
                                                                                           id="Username"><shiro:principal/></span></span>
        ...
        <div class="top_banner">
            ...
            <ul class="switch">
                ...
                <li class="switch_li" style="margin-top: -40px;text-align: center;"><img
                        src="image/findex/bannerlogo.png"></li>
        ...
        <div id="contents" class="contents">
            ...
            <div class="right" id="righth">
                ...
                <div class="right_content" id="right_Content">
                            ...
                            <c:if test="${solutions.size() > 0}">
                                <c:forEach var="solution" items="${solutions}" varStatus="status">
                                    <li>
                                        ...
                                        <div class="rp_item2">
                                            <span class="Subkind">${solution.category.TMCName}</span>
                                            <span
                                                    class="Subkind">${solution.category.parentTMC.TMCName}</span>
                                            <span
                                                    class="Subkind2">${fn:substring(solution.createDate,0,10)}<img
                                                    class="new_img" src="image/problem/new3.png"/>
					                            </span>
                                        </div>
                                    </li>
                                </c:forEach>
                    ...
                    <div class="rp_hot" id="rp_Hot">
                        <div class="hot_tborder" id="hot_Tborder">
                            <img src="image/problem/hot_tborder.png"/>
                        </div>
                        <div class="hot_panel" id="hot_Panel">
                            <h2 class="hot_title">最热门查询资料</h2>
                            <ul>
                                <c:if test="${hotVisitSolution.size() > 0}">
                                    <c:forEach var="solution" items="${hotVisitSolution}" varStatus="status">
                                        <li><span class="hot_item" id="hot_Item">
				                        <a href="searchSolution_searchSolutionById?solutionId=${solution.solutionId}"
                                           target="_blank">${solution.title}</a>
				                    </span>
                                            <span class="hot_push" id="hot_Push">点击率：<span class="count"
                                                                                           id="Count">${solution.clickNum}</span></span>
                                        </li>
                                    </c:forEach>
                                </c:if>
                        ...
                        <div class="hot_bborder" id="hot_Bborder">
                            <img src="image/problem/hot_bborder.png"/>
                        </div>

                    </div>
                    <div class="rp_key" id="rp_Key">
                        <div class="key_tborder" id="key_Tborder">
                            <img src="image/problem/key_tborder.png"/>
                        </div>
                        <div class="key_panel" id="key_Panel">
                            <h2 class="key_title" id="key_Title">最近查询关键字</h2>
                            <ul>
                                <c:if test="${lastKeywords.size() > 0}">
                                    <c:forEach var="lastKeyword" items="${lastKeywords}" varStatus="status">
                                        <li>
                                            <a href="searchSolution?pageSize=15&searchContent=${lastKeywords[status.index]}&currentPage=1">${fn:substring(lastKeyword,0,20)}</a>
                                        </li>
                                    </c:forEach>
                                </c:if>
                        ...
                        <div class="key_border" id="key_Bborder">
                            <img src="image/problem/key_bborder.png"/>
                        </div>
                    </div>
