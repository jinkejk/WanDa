	...
	<center>
		...
		<table border="1">
			<tr>
				...
				<td width="300">				
                    ...
                    <img id="showImage" width="300" height="200"/>
				</td>
			</tr>
		</table><br>
	    <form action="operateHouse_uploadHouse" method="post" onsubmit="return check()">
		   <table border="1">
			<tr>
				<td>楼盘名称</td>
				<td><input type="text" name="LPName" id="LPName"></td>
			</tr>
			<tr>
				<td>户型名称</td>
				<td><input type="text" name="HXName" id="HXName"></td>
			</tr>
			<tr>
				<td>建筑面积</td>
			...
			<tr>
				<td>总层数</td>
				<td><input type="text" name="layer" id="layer"></td>
			</tr>
			<tr>
				<td>外窗材型</td>
				<td><input type="text" name="outWinType" id="outWinType"></td>
			</tr>
			<tr>
				<td>外墙保温材料</td>
				<td><input type="text" name="warmMaterial" id="warmMaterial"></td>
			</tr>
			<tr>
				<td>分户楼板保温材料</td>
				<td><input type="text" name="insulation" id="insulation"></td>
			</tr>
			<tr>
				<td>分户楼板隔声材料</td>
				<td><input type="text" name="soundProof" id="soundProof"></td>
			</tr>
			<tr>
				<td>遮阳形式</td>
				<td><input type="text" name="shadeType" id="shadeType"></td>
			</tr>
			<tr>
				<td>是否有太阳能热水器</td>
				<td><input type="text" name="hasSolar" id="hasSolar"></td>
			</tr>			
		</table>
		    <div id="msg"></div>		
