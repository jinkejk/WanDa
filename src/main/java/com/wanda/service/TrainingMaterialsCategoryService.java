...
public interface TrainingMaterialsCategoryService {
	/**
	 * 添加
	 */
	 ...
	 * 响应异步查询数据操作
	 */
	String getSecondLevelTMCJsonByFirstLevelTMCId(Integer TMCId);
	 ...
	 * 响应异步查询数据操作
	 */
	String getFirstLevelTMCJsonByFModule(String module);
